/* Five clear mobile destinations; the remaining pages live one tap away. */
const mobileDestinations=[['home','home','Home'],['transactions','transactions','Expenses'],['wallets','wallet','Wallets'],['bills','receipt','Bills']];
const extraDestinations=[['loans','loan','Loans'],['calendar','calendar','Calendar'],['insights','insights','Insights'],['more','more','Settings']];
...
function drawMobileNav(){
  ...
  document.body.dataset.showFab=current==='home'&&!view.querySelector('.start-card')?'yes':'no';
